...
_unblock:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  38:	89 c3                	mov    %eax,%ebx
    if (unblock(syscall_id) < 0) {
  3a:	e8 34 03 00 00       	call   373 <unblock>
  3f:	83 c4 10             	add    $0x10,%esp
  42:	85 c0                	test   %eax,%eax
  44:	78 16                	js     5c <main+0x5c>
        printf(2, "Failed to unblock syscall %d\n", syscall_id);
    } else {
        printf(1, "Unblocked syscall %d\n", syscall_id);
  46:	50                   	push   %eax
  47:	53                   	push   %ebx
  48:	68 93 07 00 00       	push   $0x793
  4d:	6a 01                	push   $0x1
...
free(void *ap)
{
 ...
 5d1:	a1 b4 0a 00 00       	mov    0xab4,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 b4 0a 00 00    	mov    %edx,0xab4
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 b4 0a 00 00    	mov    %edx,0xab4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d b4 0a 00 00    	mov    0xab4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d b4 0a 00 00    	mov    0xab4,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 b4 0a 00 00    	mov    %edx,0xab4
}
 ...
 71f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 b4 0a 00 00 b8 	movl   $0xab8,0xab4
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf b8 0a 00 00       	mov    $0xab8,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 b8 0a 00 00 b8 	movl   $0xab8,0xab8
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 742:	00 00 00 
    if(p->s.size >= nunits){
