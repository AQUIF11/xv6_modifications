...
int main(int argc, char *argv[]) {
  ...
  38:	89 c3                	mov    %eax,%ebx
    if (block(syscall_id) < 0) {
  3a:	e8 2c 03 00 00       	call   36b <block>
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 04 08 00 00 	movzbl 0x804(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 ac 07 00 00 	jmp    *0x7ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
          s = "(null)";
 5b8:	ba a3 07 00 00       	mov    $0x7a3,%edx
        while(*s != 0){
