...
int main(void) {
  ...
  1d:	6a 40                	push   $0x40
  1f:	50                   	push   %eax
  20:	e8 4e 03 00 00       	call   373 <gethistory>

    if (count < 0) {
  25:	83 c4 10             	add    $0x10,%esp
  28:	85 c0                	test   %eax,%eax
  2a:	78 47                	js     73 <main+0x73>
  ...
  71:	75 dd                	jne    50 <main+0x50>
        exit();
  73:	e8 5b 02 00 00       	call   2d3 <exit>
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
          s = "(null)";
 5c8:	ba 86 07 00 00       	mov    $0x786,%edx
        while(*s != 0){
