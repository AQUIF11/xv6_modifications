...
int main(void) {
  ...
  60:	68 9c 07 00 00       	push   $0x79c
  65:	6a 01                	push   $0x1
  67:	e8 d4 03 00 00       	call   440 <printf>
    for (int i = 0; i < count; i++) {
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 b0 07 00 00 	jmp    *0x7b0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
          s = "(null)";
 5c8:	ba a6 07 00 00       	mov    $0x7a6,%edx
        while(*s != 0){
